...
public class GameManager : MonoBehaviour
{
    ...
    {
        Settings.soundVolume = soundSlider.value * 30;
    ...
    private void Start()
    {
        ...
        skillsPos.gameObject.SetActive(false);
    ...
    void LoadGame()
    {
        ...
        soundSlider.value = Settings.soundVolume / 30;
    ...
    public void OnSessionUpdate(NetworkMessage netMsg)
    {
        ...
        skillsPos.gameObject.SetActive(true);
    ...
    public MobileAgent CreateAgent(MObjects.AgentInfo mObject)
    {
        ...
        if (mObject.isController)
        {
            ...
            for (int i = 0; i < sCount; i++)
            {
                ...
                s.gameObject.GetComponent<RectTransform>().position = skillsPos.GetChild(i).gameObject.GetComponent<RectTransform>().position;
                s.name = i.ToString();
